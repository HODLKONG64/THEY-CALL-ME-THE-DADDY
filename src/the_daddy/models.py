...
class ArchitecturePlan(BaseModel):
    ...
    proof_requirements: list[str] = Field(default_factory=lambda: ["tests pass", "no import errors", "no policy violations"])
...
class LearningJournalEntry(BaseModel):
    run_id: str
    role_mode: Literal["bounded_maintenance"] = "bounded_maintenance"
    confidence: Literal["high", "medium", "low"] = "medium"
    outcome: Literal["success_patch", "safe_noop", "blocked_patch", "verification_failure"] = "safe_noop"
